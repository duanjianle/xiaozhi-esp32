...
#define TAG "AI_WALI_0_96OLED_S3SUPERMINI"

class AI_WALI_0_96OLED_S3SUPERMINI : public WifiBoard {
private:
...
DECLARE_BOARD(AI_WALI_0_96OLED_S3SUPERMINI);
