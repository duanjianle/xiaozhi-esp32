...
// 默认是 ES7210+ES8311+NS4150B的音频版，以下基于这个配置
...
#define AUDIO_I2S_MIC_GPIO_WS   GPIO_NUM_8  // 音频板的 WS  (麦克风与喇叭共用帧时钟)
#define AUDIO_I2S_MIC_GPIO_SCK  GPIO_NUM_10  // 音频板的 BCK (麦克风与喇叭共用位时钟)

// 独立音频输入、输出
#define AUDIO_I2S_MIC_GPIO_DIN  GPIO_NUM_7  // 音频板的 DI  (输入：麦克风+AEC回采信号)
#define AUDIO_I2S_SPK_GPIO_DOUT GPIO_NUM_9   // 音频板的 DO  (输出：小智说话放音数据)   // 原MAX98357 的 DIN
...
#define AUDIO_CODEC_I2C_SDA_PIN GPIO_NUM_13     //设置共用
#define AUDIO_CODEC_I2C_SCL_PIN GPIO_NUM_12     //设置共用
...
#define AUDIO_CODEC_ES8311_ADDR  ES8311_CODEC_DEFAULT_ADDR  // ES8311 的 I2C 地址，通常是 0x30（对应7位地址0x18）
#define AUDIO_CODEC_ES7210_ADDR  (0x82)  // ES7210 的 I2C 地址，通常是 0x41（对应7为地址0x82），0x58，0x80，
#define AUDIO_CODEC_PA_PIN       GPIO_NUM_NC    // 功放使能引脚 EN引脚，GPIO_NUM_NC 时代表-1,不控制功放，需要物理上直连3.3V
#define AUDIO_I2S_SPK_GPIO_MCLK  GPIO_NUM_11    // GPIO_NUM_NC代表不使用外部 MCLK，ES8311 和 ES7210 将在内部倍频模式下工作
